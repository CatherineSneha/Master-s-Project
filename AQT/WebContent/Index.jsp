...
<!-- Gets the session details from the servlet 
     If username is null redirects to the Login Page
     else will display the Index/Home Page
  -->
	<%
  ...
  <section class="coloured-section" id="title">
    ...
    <nav class="navbar  navbar-dark full-screen-nav">
     ...
     <div class="collapse nav-collapse backdrop" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto" id="test">
        ...
        <li class="nav-item">
           <a class="nav-link" href="/AQT/Logout">Logout</a>
        </li>
      </ul>
      </div>
    </nav>
    ...
    <div class="row">
       ...
       <div class="col-lg-6">
       <h1 class="big-heading">Hello ${email}!</h1>
