...
<!-- Gets the session details from the servlet  -->
	...
	<sql:setDataSource var = "snapshot" driver = "com.mysql.jdbc.Driver"
      ...
      <sql:query dataSource = "${snapshot}" var = "result">
       SELECT * FROM test_db.user_details </sql:query>
	...
	<br><br>
    <a href="Register.jsp"><button class="btn btn-outline-dark btn-dark my-2 my-sm-0" type="submit" style="color: beige;">ADD USER</button></a>
